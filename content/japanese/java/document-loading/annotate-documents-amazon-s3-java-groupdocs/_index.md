...
#### ステップ 3: コンテンツをストリーミングする (ここで魔法が起こります)
...
## Java S3ドキュメントアノテーションに関する高度なヒント
