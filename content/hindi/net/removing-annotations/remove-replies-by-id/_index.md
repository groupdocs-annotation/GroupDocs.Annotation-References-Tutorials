...
### 1. GroupDocs.Annotation इंस्टालेशन
 सबसे पहले, आपको .NET के लिए GroupDocs.Annotation इंस्टॉल करना होगा। आप यहां से लाइब्रेरी डाउनलोड कर सकते हैं[यहाँ](https://releases.groupdocs.com/annotation/net/) और दस्तावेज़ में दिए गए इंस्टॉलेशन निर्देशों का पालन करें[यहाँ](https://reference.groupdocs.com/annotation/net/).
